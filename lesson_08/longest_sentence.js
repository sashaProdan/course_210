...
// output the words count in the sentence
...
function longestSentence(text) {
  ...
  var sentenceObjects = sentences.map(function(sentence) {
    return {
      text: sentence,
  ...
  var longestSentence = sentenceObjects.sort(function(sentence1, sentence2) {
    return sentence2.count - sentence1.count;
  })[0];
